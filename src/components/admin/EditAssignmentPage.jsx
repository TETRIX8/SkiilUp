...
export const EditAssignmentPage = () => {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [topicsResponse, assignmentResponse] = await Promise.all([
        apiClient.getTopics(),
      ...
      setFormData({
        topic_id: assignmentResponse.assignment.topic_id.toString(),
        title: assignmentResponse.assignment.title,
        description: assignmentResponse.assignment.description || '',
        instructions: assignmentResponse.assignment.instructions || '',
        max_score: assignmentResponse.assignment.max_score,
        due_date: assignmentResponse.assignment.due_date ? assignmentResponse.assignment.due_date.split('T')[0] : ''
      });
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await apiClient.updateAssignment(id, submitData);
      ...
      setError('Ошибка обновления задания: ' + error.message);
    } finally {
      setSaving(false);
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-bold text-gray-900">Редактирование задания</h1>
            </div>
          </div>
        </div>
      </motion.header>
              ...
              <Card className="shadow-lg rounded-2xl overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
                  ...
                  <CardDescription className="text-blue-100">
                    Измените основную информацию о задании
                  </CardDescription>
                </CardHeader>
